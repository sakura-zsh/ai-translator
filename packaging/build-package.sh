...
mkdir -p "$STAGING/${PKGNAME}-${PKGVER}/packaging"
cp -a "$PKGDIR/ai-translator.desktop" "$STAGING/${PKGNAME}-${PKGVER}/packaging/"
cp -a "$PKGDIR/ai-translator" "$STAGING/${PKGNAME}-${PKGVER}/packaging/"
chmod 755 "$STAGING/${PKGNAME}-${PKGVER}/packaging/ai-translator"
